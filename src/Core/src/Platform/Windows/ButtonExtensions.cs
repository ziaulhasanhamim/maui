...
namespace Microsoft.Maui
{
	...
	{
		public static void UpdateBackgroundColor(this MauiButton nativeButton, IButton button, UI.Xaml.Media.Brush? defaultBrush = null) =>
		...
		public static void UpdateCharacterSpacing(this MauiButton nativeButton, IButton button) =>
			nativeButton.UpdateCharacterSpacing(button.CharacterSpacing.ToEm());
